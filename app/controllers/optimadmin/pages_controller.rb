module Optimadmin
  class PagesController < Optimadmin::ApplicationController
    ...
    edit_images_for Page, [[:image, { show: ['fit', 362, 362] }]]
  ...
  private
    ...
    def page_params
      params.require(:page).permit(:title, :suggested_url, :image, :image_cache, :remove_image, :remote_image_url, :display, :content, :style, :layout, :file, :file_cache, :remove_file, :remote_file_url, :file_download_text)
    end
  end
end
